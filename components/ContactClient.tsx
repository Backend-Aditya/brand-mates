          ...
          <div className="ct-sidebar opacity-0 translate-y-8 flex flex-col gap-5 lg:sticky lg:top-24">
            ...
            <div className="relative rounded-2xl overflow-hidden p-6 bg-linear-to-br from-brand-400 to-brand-300 text-brand-700">
              ...
              <div className="relative">
                ...
                <a href="mailto:info@brandmates.au?subject=Discovery%20call%20booking" className="group inline-flex items-center justify-center gap-1.5 rounded-full bg-brand-700 text-brand-300 hover:bg-brand-ink font-bold text-sm py-3 w-full transition-colors">
                  Book this slot
            ...
            <div className="rounded-2xl border border-white/5 bg-white/2 p-6 flex flex-col gap-4">
              ...
              <a href="mailto:info@brandmates.au" className="group flex items-center gap-3 text-white/70 hover:text-brand-400 transition-colors text-sm">
