...
export const metadata: Metadata = {
  ...
  description: "BrandMates is an Australian brand studio for founders and CMOs who need identity, digital, and content work that holds up in the real world - based in Sydney.",
  openGraph: {
    title: "BrandMates - Australia's Brand Studio. We Build Belief.",
  ...
  alternates: { canonical: "https://www.brandmates.au" },
};
